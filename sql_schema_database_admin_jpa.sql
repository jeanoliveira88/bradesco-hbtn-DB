CREATE TABLE Aluno (id  integer, email varchar(255), matricula varchar(255), nascimento datetime, nomeCompleto varchar(255), curso_id bigint, endereco_id bigint, telefone_id bigint, primary key (id))
